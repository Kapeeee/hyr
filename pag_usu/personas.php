...
<script src="../js/funcionesPer.js"></script>
...
<div class="col-12 text-center">
  <h3>Personas Actuales&nbsp;&nbsp;<i class="fa fa-user" aria-hidden="true"></i></h3>
  <hr>
</div>
